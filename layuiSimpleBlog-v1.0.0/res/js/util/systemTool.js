...
function GetOs() {
    ...
    let isWin = (navigator.platform === 'Win64' || navigator.platform === 'Win32') || (navigator.platform === 'Windows')
...
function getBaseUrl() {
    ...
    return "http://111.229.42.116:8080/blog";
}

export const dataFun = {
    GetCurrentBrowser, GetOs, mime,getBaseUrl
};